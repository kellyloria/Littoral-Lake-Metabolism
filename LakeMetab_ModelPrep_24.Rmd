...
```{r}
#  write.csv(result, file = "/Users/kellyloria/Documents/LittoralMetabModeling/Sondefiles/sonde_prep_all.csv", row.names = TRUE)
...
```{r}
prep_R_for_LM(sonde_check = result, freq = 24, site = "BWNS1")
```

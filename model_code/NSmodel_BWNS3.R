...
# read data in
data <- read_rdump(paste("./ModelInputs/BWNS3_2021_sonde_list.R",sep=""))
...
# data
sonde_data <- read_csv(paste0("./ModelInputs/sonde_prep_BWNS3_2021.csv"))
...
ggsave(plot = p1,filename = paste("./graphics/BWN32fit_2021.png",sep=""),width=8,height=4.5,dpi=300)
...
ggsave(plot = p2,filename = paste("./graphics/BWN32metab_2021.png",sep=""),width=8,height=4.5,dpi=300)
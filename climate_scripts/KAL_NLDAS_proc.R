...
# ggsave("./NLDAS_Light_plot.png", plot = plot, width = 12, height = 3, units = "in")
...
# Call the function with your parameters
gdat1 <- GLDAS_proc("~/Documents/LittoralMetabModeling/RawData/NLDAS/GLDAS_windsp/",
...
# ggsave(plot = grid, filename = paste("~/Documents/LittoralMetabModeling/RawData/NLDAS/NLDAS_NSdata.png",sep=""),width=12,height=8,dpi=300)
